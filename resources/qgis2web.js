...
map.getView().fit([-8369971.908852, 1145567.578540, -8369421.272494, 1145904.916644], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Proyecto Mahates</h2>';
        return titleElement;
    })(),
